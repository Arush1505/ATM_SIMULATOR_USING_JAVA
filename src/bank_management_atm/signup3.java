...
//        
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(ae.getSource()==b1){
                ...
                if(atype.equals("")){
                    ...
                    int rows_affect_signup3=c1.s.executeUpdate(q1);
                    int rows_affect_login=c1.s.executeUpdate(q2);
                    
                    
                    if (rows_affect_login>0 && rows_affect_signup3>0)
                    {
                        String text = "Card Number: " + cardno + "\n Pin: " + pin;
                        JTextPane jj = new JTextPane(); 
                        jj.setText(text);
                        jj.setEditable(false);
                        jj.setContentType("text/plain");
                        
                        JOptionPane.showMessageDialog(null,jj,"YOUR CARD DETAILS",JOptionPane.INFORMATION_MESSAGE);
    	...
    	{
    		JOptionPane.showMessageDialog(null, " Agree all the T&C to continue","Warning",JOptionPane.WARNING_MESSAGE);
    	}
    }
